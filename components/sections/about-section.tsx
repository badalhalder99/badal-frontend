...
export function AboutSection() {
  ...
  return (
    <section className="bg-black px-4 py-[160px] text-white small:px-10 medium:py-[200px] light:bg-neutral-25 light:text-neutral-950">
      <div className="mx-auto flex w-full max-w-[1280px] flex-col items-center gap-8 text-center min-[981px]:max-w-[901px] 2xlarge:max-w-[1280px]">
        <p className="gradient-badge inline-flex h-9 items-center justify-center gap-2 rounded-[12px] px-4 py-2 text-[15px] font-normal leading-[1.35] text-[#D0D5D9] shadow-[0_8px_40px_rgba(36,102,242,0.15)] [--badge-bg:#171B21] light:[--badge-bg:#FFFFFF] light:text-neutral-700">
          <span className="size-2 rounded-full bg-[#2466F2] shadow-[0_2px_12px_rgba(36,102,242,0.5)]" />
          Are Distractions Holding You Back?
        </p>

        <h2 className="max-w-[348px] text-[28px] font-normal leading-[1.15] text-[#E0E3E5] small:max-w-[401px] medium:max-w-[545px] medium:text-[40px] large:max-w-[928px] large:text-[52px] min-[981px]:max-[1439px]:max-w-[821px] 2xlarge:max-w-[928px] light:text-neutral-950">
